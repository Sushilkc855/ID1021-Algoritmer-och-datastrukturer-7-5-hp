    ...
    public static void main(String[] args) {
       ...
       // object2.print();    
        ...
        int z = 0; 
            ...
            for(int i = 0; i<k; i++){
                DoubleLinkedList current = object.getItemAtIndex(sequence[i]);
                t0 = System.nanoTime(); 
                removedItem = object.removeItem(current);
...
public class DoubleLinkedList {
    ...
    public int removeItem(DoubleLinkedList index){
        DoubleLinkedList current = index; 
    ...
    public DoubleLinkedList getItemAtIndex(int index){
